<template>
  <div class="w-full m-1 sm:w-11/12 md:w-10/12 lg:w-9/12 2xl:w-8/12">
    <div class="border shadow-lg rounded-lg w-full p-4">
      ...
      <div v-else>
        ...
        <div v-else>
          ...
          <div
            class="border shadow-lg p-3 rounded-lg m-auto sm:w-11/12 md:w-10/12 lg:w-9/12 2xl:w-8/12"
          >
            <ChatHistory
              :chatRoom="chatRoom"
    ...
    <ActiveRooms v-if="chatRoomActivated" />
  </div>
</template>
